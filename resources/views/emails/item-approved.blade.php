                    ...
                    <table class="outer" align="center" cellpadding="0" cellspacing="0" border="0" style="border-spacing:0;Margin:0 auto;width:100%;max-width:600px;">
                        <tr>
                            <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                                                                ...
                                                                <tr>
                                                                    <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" bgcolor="#FFFFFF"><!-- ======= start header ======= -->
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#f3f2f0">
                                                                            <tr>
                                                                                <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;font-size:0;" ><!--[if (gte mso 9)|(IE)]>
                                                                                    ...
                                                                                    <div class="column" style="width:100%;max-width:580px;display:inline-block;vertical-align:top;">
                                                                                        <table width="100%" style="border-spacing:0" cellpadding="0" cellspacing="0" border="0" >
                                                                                            <tr>
                                                                                                <td class="inner" style="padding-top:0px;padding-bottom:10px; padding-left:10px;">
                                ...
                                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-top:1px solid #e8e7e5;" bgcolor="#FFFFFF">
                                    <tr>
                                        <!-- <td background="images/bg.jpg" bgcolor="#fff" width="600" height="353" valign="top" align="center" style="padding:50px 50px 10px 50px; background-size:100%; background-repeat:no-repeat;"><!--[if gte mso 9]> -->
                                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width:600px;height:303px;">
                                            <v:fill type="tile" src="https://api.yourdesignjuice.com/images/bg.jpg" color="#2f9780" />
                                            <v:textbox inset="0,0,0,0">
                                                <![endif]-->
                                                <div>
                                                    <table border="0" align="right" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                                        <tbody>
                                                        <tr>
                                                            <!--<td align="center"></td>-->
                                                        </tr>
                                ...
                                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5;" bgcolor="#FFFFFF">
                                    <tr>
                                        <td align="center" style="padding:40px 90px 20px 90px; border-bottom:1px solid #e8e7e5;"><p style="color:#3d3d3d; font-size:18px; ">
                                                <strong>Congrats!! Your item is approved for sale.</strong></p>
                                            <img src="https://api.yourdesignjuice.com/images/icon-smiley.png"><br /><br />
                                            <p style="text-align:left;">Hi {{ $name }},</p>
                                            <p style="text-align:left;"><span style="line-height:20px">We have reviewed your recently uploaded design asset [ Item Name ] and we're glad to inform it has been approved.</span></p>
                                            <p style="line-height:20px; text-align:left;">Good job! Your item is now listed on YDJ Marketplace.</p>
                                            <p style="line-height:20px; text-align: left">We built a beautiful, simple and easy to understand analytics for you so that you can keep track of your selling performance. Just head to your <strong>Dashboard</strong> to view it.</p>
                                            <p style="line-height:20px; text-align: left">Regards,<br>
                                                YDJM Team</p>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    ...
                                    <!--[if (gte mso 9)|(IE)]></td><td width="40%" valign="top" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" >
                                    <![endif]-->
                                                ...
                                                <td class="inner" style="padding-top:0px;padding-bottom:10px; padding-right:10px;padding-left:10px;"><table class="contents" style="border-spacing:0; width:100%">
                                                        <tr>
                                                            <td width="32%" align="center" valign="top" style="padding-top:10px"><table width="150" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td width="33" align="center"><a href="https://www.pinterest.com/yourdesignjuice/pins" target="_blank"><img src="https://api.yourdesignjuice.com/images/pn.jpg" alt="pinterest" width="36" height="36" border="0" style="border-width:0; max-width:36px;height:auto; display:block; max-height:36px"/></a></td>
                                                                        <td width="34" align="center"><a href="https://www.facebook.com/YourDesignJuice.YDJ" target="_blank"><img src="https://api.yourdesignjuice.com/images/fb.jpg" alt="facebook" width="36" height="36" border="0" style="border-width:0; max-width:36px;height:auto; display:block; max-height:36px"/></a></td>
                                                                        <td width="33" align="center"><a href="https://twitter.com/yourdesignjuice" target="_blank"><img src="https://api.yourdesignjuice.com/images/twitter.jpg" alt="instagram" width="36" height="36" border="0" style="border-width:0; max-width:36px;height:auto; display:block; max-height:36px"/></a></td>
                                                                    </tr>
                                                                </table></td>
                                                        </tr>
                                                    </table></td>
